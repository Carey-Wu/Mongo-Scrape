...
app.get("/scrape", function (req, res) {
    ...
    axios.get("http://news.mit.edu/topic/computers").then(function (response) {
      ...
      $("li").each(function (i, element) {
        ...
        result.summary = $(this)
          .children("p")
          .text();
        result.link = "http://news.mit.edu" + $(this)
          .children("h3")
          .children("a")
          .attr("href");
...
// Route for deleting/updating an Article's associated Comment
